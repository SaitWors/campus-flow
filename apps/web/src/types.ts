...
export type User = {id:string;email:string;name:string;role:Role;group_role?:'none'|'head'|'deputy';status:'active'|'pending'|'blocked';subgroup:number};
